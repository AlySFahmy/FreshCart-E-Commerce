...
export default function Products() {
  ...
  let { setnumOfCartItems, addProductToCart, addToWishList, getWish } =
  ...
  let { isLoading, isFetching, data, refetch } = useQuery(
    "getProduct",
    getProducts,
    {
      // cacheTime:2000,
  ...
  return (
    <>
      <input type="text" className=" form-control w-100 my-4 py-3" placeholder="Search" onChange={(e) => setSearch(e.target.value)} />
      <div className="row">
        <Toaster />
              ...
              <div key={product.id} className="col-md-3 my-5 overflow-hidden">
                <div className="product p-3 rounded-3">
                  ...
                  <div className="d-flex gap-1 justify-content-between">
                    ...
                    <button onClick={() => addToCart(product._id)} className="btn bg-main btn-small w-100 text-white">
                      Add to cart
                    </button>
                  </div>
                </div>
